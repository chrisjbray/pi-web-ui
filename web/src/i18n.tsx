...
export const zh = {
	...
	tmuxNewWindow: "新建 tmux 窗口",
	tmuxTakeControl: "接管终端（读写）",
	tmuxTakeControlShort: "接管",
	tmuxRelease: "释放为只读",
	tmuxReleaseShort: "只读",
	tmuxReadonly: "只读",
	tmuxAdopted: "领养",
	tmuxDetach: "断开领养（真终端不受影响）",
	tmuxDetachShort: "断开",
	tmuxAdoptGroup: "领养的 tmux 会话",
	tmuxAdopt: "领养（只读）",
	tmuxNoAdoptable: "暂无可领养的 tmux 会话",
...
const en: Record<keyof typeof zh, string> = {
	...
	tmuxNewWindow: "New tmux window",
	tmuxTakeControl: "Take control (read-write)",
	tmuxTakeControlShort: "Take over",
	tmuxRelease: "Release to read-only",
	tmuxReleaseShort: "Read-only",
	tmuxReadonly: "read-only",
	tmuxAdopted: "adopted",
	tmuxDetach: "Detach adoption (real terminal unaffected)",
	tmuxDetachShort: "Detach",
	tmuxAdoptGroup: "Adopted tmux sessions",
	tmuxAdopt: "Adopt (read-only)",
	tmuxNoAdoptable: "No adoptable tmux sessions",
